...
public class GroupInstancePermissionServiceSecuredTest extends BasePermissionServiceTest<GroupInstancePermissionServiceSecured, GroupInstancePermission> {

    @Mock
    GroupInstancePermissionRepository repositoryMock;

    @InjectMocks
    GroupInstancePermissionServiceSecured service;
    ...
    @Test
    public void setPermission_BaseEntity_Group_PermissionCollectionType_IsAnnotatedAsExpected() throws NoSuchMethodException {
        PreAuthorize createPreAuthorize =
            service.getClass().getMethod("setPermission", BaseEntity.class, Group.class, PermissionCollectionType.class).getAnnotation(PreAuthorize.class);
    ...
    @Test
    public void setPermission_List_Group_PermissionCollectionType_IsAnnotatedAsExpected() throws NoSuchMethodException {
        PreFilter createPreAuthorize =
            service.getClass().getMethod("setPermission", List.class, Group.class, PermissionCollectionType.class).getAnnotation(PreFilter.class);
