...
public class ApplicationPermissionEvaluator extends BaseEntityPermissionEvaluator<Application> {
    ...
    @Override
    public boolean hasPermission(User user, Application application, PermissionType permission) {
         if (permission.equals(PermissionType.READ) &&
             application.getPublicAccess() != null && application.getPublicAccess()) {
             return true;
         }

         return super.hasPermission(user, application, permission);
    }
