...
//        Optional<Role> userOptional = repository.findByAuthProviderId(authProviderId);
//        Role role = userOptional.orElse(null);
//
//        if (role == null) {
//            log.debug("User with keycloak id {} was deleted in Keycloak. It did not exists in SHOGun DB. No action needed.", authProviderId);
//            return;
//        }
//
//        userInstancePermissionService.deleteAllFor(role);
//        repository.delete(role);
//        log.info("User with keycloak id {} was deleted in Keycloak and was therefore deleted in SHOGun DB, too.", authProviderId);
//    }
